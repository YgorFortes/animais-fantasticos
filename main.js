...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ iniciarDropDownMenu)\n/* harmony export */ });\n/* harmony import */ var _outesideclick_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outesideclick.js */ \"./js/modules/outesideclick.js\");\n\nfunction iniciarDropDownMenu() {\n  var dropdownMenus = document.querySelectorAll('[data-dropdown]');\n  function handleClick(evento) {\n    var _this = this;\n    evento.preventDefault();\n    this.classList.add('ativo');\n    (0,_outesideclick_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this, ['touchstart', 'click'], function () {\n      _this.classList.remove('ativo');\n    });\n  }\n  dropdownMenus.forEach(function (menu) {\n    menu.addEventListener('touchstart', handleClick);\n    menu.addEventListener('click', handleClick);\n  });\n}\n\n//# sourceURL=webpack://projeto-animais-fantasticos/./js/modules/dropdown-menu.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ outersideClick)\n/* harmony export */ });\nfunction outersideClick(element, events, callback) {\n  var html = document.documentElement;\n  var outside = 'data-outside';\n  function handleOutsideClick(event) {\n    if (!element.contains(event.target)) {\n      element.removeAttribute(outside);\n      html.removeEventListener('click', handleOutsideClick);\n    }\n    callback();\n  }\n  if (!element.hasAttribute(outside)) {\n    events.forEach(function (userEvent) {\n      setTimeout(function () {\n        html.addEventListener(userEvent, handleOutsideClick);\n      });\n    });\n    element.setAttribute(outside, '');\n  }\n}\n\n//# sourceURL=webpack://projeto-animais-fantasticos/./js/modules/outesideclick.js?");
